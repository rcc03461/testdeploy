...
const Model = require('../data/filemanager');
...
Controller.upload = async function (req, res) {
  ...
  const rawData = await Model.add(req.file.originalname, req.file.path, path.extname(req.file.originalname), req.file.mimetype, req.file.size, req.body.createId);
